 ...
 * customer swipes (drags her finger) horizontally across the view.
 *
 *
 * <p>Example usage:</p>
 *
...
public class SwipeDismissTouchListener implements View.OnTouchListener {
    ...
    public interface DismissCallbacks {
        ...
        /**
         * Called when the customer has indicated they she would like to dismiss the view.
         *
     ...
     * @param callbacks The callback to trigger when the customer has indicated that she would like to
     */
